...
import { Loader2Icon, PlusIcon, Slice, TrashIcon } from "lucide-react"
                ...
                <Link
                  ...
                  <div className="relative w-full h-40 bg-gray-900 overflow-hidden border-b border-gray-800">
                    {project.current_code ? (
                      <iframe
                        ...
                        className="absolute top-0 left-0 w-[1200px] h-[800px] origin-top-left pointer-events-none" sandbox='allow-scripts allow-same-origin' style={{ transform: 'scale(0.25)' }} />
                    ) : (
                  ...
                  <div className='p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors'>
                    ...
                    <div className="flex justify-between items-center mt-6">
                      <span className="test-xs text-shadow-gray-500">{new Date(project.createdAt).toLocaleDateString()}</span>
